...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/OperatorFoundation/Song.git", from: "0.0.21"),
        ...
        .package(url: "https://github.com/OperatorFoundation/Datable.git", from: "3.0.0"),
    ...
    targets: [
        ...
        .target(
            name: "ReplicantSwift",
            dependencies: ["Monolith", "Datable", "Transport", "Song", .product(name: "Logging", package: "swift-log")]),
        .testTarget(
