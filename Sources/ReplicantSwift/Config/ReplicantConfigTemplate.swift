...
//    var maybeToneBurst: ToneBurst?
//    
//    public init(polishClientConfig: PolishClientConfig?, toneBurst: ToneBurst?)
//    {
//        self.maybePolishClientConfig = polishClientConfig
//        self.maybeToneBurst = toneBurst
//    }
//    
...
//        
//        guard let replicantConfig = ReplicantClientConfig(serverAddress: serverAddress, polish: self.maybePolishClientConfig, toneBurst: self.maybeToneBurst, transport: "Replicant") else
//        {
//            return false
//        }
//
